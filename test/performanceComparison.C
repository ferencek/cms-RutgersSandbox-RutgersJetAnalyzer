...
void makePlotsQCD(const string & dir = "ROOT_files", const string & algo = "AK", const double Ymin = 1e-3, const Int_t Logy = 1, const string & flavor = "", const string & ext = "eps")
{
  ...
  if( flavor=="bJets" )
    flv = "b jets";
  else if( flavor=="bJetsGSP" )
    flv = "g#rightarrowb#bar{b} splitting";
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_FatJets_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_FatJets_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  //------------------------------------------------- 
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_FatJets_IVFCSV_Cone_vs_ExplJTA_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_FatJets_IVFCSV_Cone_vs_ExplJTA_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_FatJets_IVFCSV_ExplJTA_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_FatJets_IVFCSV_ExplJTA_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_Subjets_CSV_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_Subjets_CSV_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_Subjets_IVFCSV_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_Subjets_IVFCSV_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_Subjets_ExplJTA_SV_IVFCSV_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_Subjets_ExplJTA_SV_IVFCSV_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_Subjets_JP_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_Subjets_JP_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_Subjets_JBP_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_Subjets_JBP_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  orderingPt700ToInf.push_back("Subjet JBP (Pruned)");
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(),"",("btagperfcomp_Pt300to500_Subjets_Pruned_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(),0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(),"",("btagperfcomp_Pt700toInf_Subjets_Pruned_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(),0, 1, Ymin, 1, Logy);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(),"",("btagperfcomp_Pt300to500_Subjets_ExplJTA_SV_Pruned_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(),0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(),"",("btagperfcomp_Pt700toInf_Subjets_ExplJTA_SV_Pruned_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(),0, 1, Ymin, 1, Logy);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_Subjets_Pruned_IVFCSV_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_Subjets_Pruned_IVFCSV_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  graphsPt300To500["Subjet IVFCSV (k_{T})"]              = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(),            (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(),            getHistName("Kt","SubJetMinIVFCSV"), getHistName("Kt","SubJetMinIVFCSV",flavor), 300,500);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_Subjets_Kt_IVFCSV_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_Subjets_Kt_IVFCSV_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_Subjets_Pruned_Kt_IVFCSV_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_Subjets_Pruned_Kt_IVFCSV_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_Subjets_Pruned_IVFCSV_ExplJTA_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_Subjets_Pruned_IVFCSV_ExplJTA_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_Subjets_Pruned_IVFCSV_SV_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_Subjets_Pruned_IVFCSV_SV_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_Subjets_Pruned_IVFCSV_ExplJTA_SV_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_Subjets_Pruned_IVFCSV_ExplJTA_SV_comparison_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
...
void makePlotsQCDFatvsSub(const string & dir = "ROOT_files", const string & algo = "AK", const double Ymin = 1e-3, const Int_t Logy = 1, const string & flavor = "",
			  const bool overlayBTV13001 = 0, const bool overlayKtSubjets = 0, const string & ext = "eps")
{
  // for multiple plots on the same canvas
  ...
  //-------------------------------------------------
  graphsPt300To500["Fat jet CSV (*)"]       = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/QCDPythia6_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","JetCSV"),          getHistName("Pruned","JetCSV",flavor),          300,500);
  graphsPt300To500["Fat jet IVFCSV"]        = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       getHistName("Pruned","JetIVFCSV",flavor),       300,500);
  graphsPt300To500["Subjet CSV (*)"]        = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/QCDPythia6_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","SubJetMinCSV"),    getHistName("Pruned","SubJetMinCSV",flavor),    300,500);
  graphsPt300To500["Subjet IVFCSV"]         = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), getHistName("Pruned","SubJetMinIVFCSV",flavor), 300,500);
  graphsPt300To500["Subjet IVFCSV (k_{T})"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Kt","SubJetMinIVFCSV"),     getHistName("Kt","SubJetMinIVFCSV",flavor),     300,500);
  //graphsPt300To500["Subjet IVFCSV (Optimal 2D)"] = getEfficiencyCurve2D((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName2D("Pruned","IVFCSV","300to500"));

  orderingPt300To500.push_back("Fat jet IVFCSV");
  orderingPt300To500.push_back("Subjet IVFCSV");
  if(overlayBTV13001) orderingPt300To500.push_back("Fat jet CSV (*)");
  if(overlayBTV13001) orderingPt300To500.push_back("Subjet CSV (*)");
  if(overlayKtSubjets) orderingPt300To500.push_back("Subjet IVFCSV (k_{T})");
  //orderingPt300To500.push_back("Subjet IVFCSV (Optimal 2D)");
  //-------------------------------------------------
  graphsPt700ToInf["Fat jet CSV (*)"]       = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/QCDPythia6_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","JetCSV"),          getHistName("Pruned","JetCSV",flavor),          700,1100);
  graphsPt700ToInf["Fat jet IVFCSV"]        = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       getHistName("Pruned","JetIVFCSV",flavor),       700,1100);
  graphsPt700ToInf["Subjet CSV (*)"]        = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/QCDPythia6_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","SubJetMinCSV"),    getHistName("Pruned","SubJetMinCSV",flavor),    700,1100);
  graphsPt700ToInf["Subjet IVFCSV"]         = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), getHistName("Pruned","SubJetMinIVFCSV",flavor), 700,1100);
  graphsPt700ToInf["Subjet IVFCSV (k_{T})"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Kt","SubJetMinIVFCSV"),     getHistName("Kt","SubJetMinIVFCSV",flavor),     700,1100);
  //graphsPt700ToInf["Subjet IVFCSV (Optimal 2D)"] = getEfficiencyCurve2D((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName2D("Pruned","IVFCSV","700toInf"));

  orderingPt700ToInf.push_back("Fat jet IVFCSV");
  orderingPt700ToInf.push_back("Subjet IVFCSV");
  if(overlayBTV13001) orderingPt700ToInf.push_back("Fat jet CSV (*)");
  if(overlayBTV13001) orderingPt700ToInf.push_back("Subjet CSV (*)");
  if(overlayKtSubjets) orderingPt700ToInf.push_back("Subjet IVFCSV (k_{T})");
  //orderingPt700ToInf.push_back("Subjet IVFCSV (Optimal 2D)");
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), (overlayBTV13001 ? "*BTV-13-001 CA8" : ""), ("btagperfcomp_Pt300to500_FatJets_Subjets_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), (overlayBTV13001 ? "*BTV-13-001 CA8" : ""), ("btagperfcomp_Pt700toInf_FatJets_Subjets_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
...
void makePlotsOtherFatvsSub(const string & dir = "ROOT_files", const string & algo = "AK", const bool overlayBTV13001 = 0, const bool overlayKtSubjets = 0, const string & ext = "eps")
{
  // for multiple plots on the same canvas
  ...
  // Post-BTV-13-001 setup
  //==========================================
  // Fat jets and subjets -- Boosted hadronic W
  //-------------------------------------------------
  graphsPt300To500["Fat jet CSV (*)"]       = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","JetCSV"),          300,500);
  graphsPt300To500["Fat jet IVFCSV"]        = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Subjet CSV (*)"]        = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","SubJetMinCSV"),    300,500);
  graphsPt300To500["Subjet IVFCSV"]         = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  graphsPt300To500["Subjet IVFCSV (k_{T})"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Kt","SubJetMinIVFCSV"),     300,500);
  //graphsPt300To500["Subjet IVFCSV (Optimal 2D)"] = getEfficiencyCurve2D((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName2D("Pruned","IVFCSV","300to500"));
  ...
  //orderingPt300To500.push_back("Subjet IVFCSV (Optimal 2D)");
  //-------------------------------------------------
  graphsPt700ToInf["Fat jet CSV (*)"]       = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","JetCSV"),          700,1100);
  graphsPt700ToInf["Fat jet IVFCSV"]        = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       700,1100);
  graphsPt700ToInf["Subjet CSV (*)"]        = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","SubJetMinCSV"),    700,1100);
  graphsPt700ToInf["Subjet IVFCSV"]         = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 700,1100);
  graphsPt700ToInf["Subjet IVFCSV (k_{T})"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Kt","SubJetMinIVFCSV"),     700,1100);
  //graphsPt700ToInf["Subjet IVFCSV (Optimal 2D)"] = getEfficiencyCurve2D((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName2D("Pruned","IVFCSV","700toInf"));
  ...
  //orderingPt700ToInf.push_back("Subjet IVFCSV (Optimal 2D)");
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic W)", (overlayBTV13001 ? "*BTV-13-001 CA8" : ""), ("btagperfcomp_Pt300to500_FatJets_Subjets_" + algo + "_Hadronic_W." + ext).c_str(), 0, 1, 1E-3, 1, 1);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic W)", (overlayBTV13001 ? "*BTV-13-001 CA8" : ""), ("btagperfcomp_Pt700toInf_FatJets_Subjets_" + algo + "_Hadronic_W." + ext).c_str(), 0, 1, 1E-3, 1, 1);
  ...
  //-------------------------------------------------
  // Fat jets and subjets -- Boosted hadronic Z
  //-------------------------------------------------
  graphsPt300To500["Fat jet CSV (*)"]       = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","JetCSV"),          300,500);
  graphsPt300To500["Fat jet IVFCSV"]        = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Subjet CSV (*)"]        = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","SubJetMinCSV"),    300,500);
  graphsPt300To500["Subjet IVFCSV"]         = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  graphsPt300To500["Subjet IVFCSV (k_{T})"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Kt","SubJetMinIVFCSV"),     300,500);
  //graphsPt300To500["Subjet IVFCSV (Optimal 2D)"] = getEfficiencyCurve2D((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName2D("Pruned","IVFCSV","300to500"));
  ...
  //orderingPt300To500.push_back("Subjet IVFCSV (Optimal 2D)");
  //-------------------------------------------------
  graphsPt700ToInf["Fat jet CSV (*)"]       = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","JetCSV"),          700,1100);
  graphsPt700ToInf["Fat jet IVFCSV"]        = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       700,1100);
  graphsPt700ToInf["Subjet CSV (*)"]        = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","SubJetMinCSV"),    700,1100);
  graphsPt700ToInf["Subjet IVFCSV"]         = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 700,1100);
  graphsPt700ToInf["Subjet IVFCSV (k_{T})"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Kt","SubJetMinIVFCSV"),     700,1100);
  //graphsPt700ToInf["Subjet IVFCSV (Optimal 2D)"] = getEfficiencyCurve2D((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName2D("Pruned","IVFCSV","700toInf"));
  ...
  //orderingPt700ToInf.push_back("Subjet IVFCSV (Optimal 2D)");
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic Z)", (overlayBTV13001 ? "*BTV-13-001 CA8" : ""), ("btagperfcomp_Pt300to500_FatJets_Subjets_" + algo + "_Hadronic_Z." + ext).c_str(), 0, 1, 1E-2, 1, 1);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic Z)", (overlayBTV13001 ? "*BTV-13-001 CA8" : ""), ("btagperfcomp_Pt700toInf_FatJets_Subjets_" + algo + "_Hadronic_Z." + ext).c_str(), 0, 1, 1E-2, 1, 1);
  ...
  //-------------------------------------------------
  // Fat jets and subjets -- Boosted hadronic top
  //-------------------------------------------------
  graphsPt300To500["Fat jet CSV (*)"]       = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/TprimeToTHinc_M-1000_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","JetCSV"),          300,500);
  graphsPt300To500["Fat jet IVFCSV"]        = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Subjet CSV (*)"]        = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/TprimeToTHinc_M-1000_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","SubJetMinCSV"),    300,500);
  graphsPt300To500["Subjet IVFCSV"]         = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  graphsPt300To500["Subjet IVFCSV (k_{T})"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Kt","SubJetMinIVFCSV"),     300,500);
  //graphsPt300To500["Subjet IVFCSV (Optimal 2D)"] = getEfficiencyCurve2D((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName2D("Pruned","IVFCSV","300to500"));
  ...
  //orderingPt300To500.push_back("Subjet IVFCSV (Optimal 2D)");
  //-------------------------------------------------
  graphsPt700ToInf["Fat jet CSV (*)"]       = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/TprimeToTHinc_M-1700_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","JetCSV"),          700,1100);
  graphsPt700ToInf["Fat jet IVFCSV"]        = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1700_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       700,1100);
  graphsPt700ToInf["Subjet CSV (*)"]        = getEfficiencyCurve((dir + "_" + "CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    (dir + "_" + "CA8/TprimeToTHinc_M-1700_HiggsTagging_BTV-13-001_PATTuple_v3.root").c_str(),                    getHistName("Pruned","SubJetMinCSV"),    700,1100);
  graphsPt700ToInf["Subjet IVFCSV"]         = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1700_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 700,1100);
  graphsPt700ToInf["Subjet IVFCSV (k_{T})"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1700_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Kt","SubJetMinIVFCSV"),     700,1100);
  //graphsPt700ToInf["Subjet IVFCSV (Optimal 2D)"] = getEfficiencyCurve2D((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1700_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName2D("Pruned","IVFCSV","700toInf"));
  ...
  //orderingPt700ToInf.push_back("Subjet IVFCSV (Optimal 2D)");
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic top)", (overlayBTV13001 ? "*BTV-13-001 CA8" : ""), ("btagperfcomp_Pt300to500_FatJets_Subjets_" + algo + "_Hadronic_top." + ext).c_str(), 0, 1, 1E-2, 1, 1);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic top)", (overlayBTV13001 ? "*BTV-13-001 CA8" : ""), ("btagperfcomp_Pt700toInf_FatJets_Subjets_" + algo + "_Hadronic_top." + ext).c_str(), 0, 1, 1E-2, 1, 1);
...
void makePlotsQCDAKvsCA(const string & dir = "ROOT_files", const double Ymin = 1e-3, const Int_t Logy = 1, const string & flavor = "", const string & ext = "eps")
{
  ...
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, "#splitline{R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}", "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt300to500_FatJets_Subjets_AK_vs_CA" + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, "#splitline{R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}",     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "", ("btagperfcomp_Pt700toInf_FatJets_Subjets_AK_vs_CA" + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
...
void makePlotsOtherAKvsCA(const string & dir = "ROOT_files", const string & ext = "eps")
{
  // for multiple plots on the same canvas
  ...
  // Post-BTV-13-001 setup
  //==========================================
  // Fat jets and subjets, AK8 vs CA8 -- Boosted hadronic W
  //-------------------------------------------------
  graphsPt300To500["Fat jet IVFCSV (Explicit JTA) - AK"]                       = getEfficiencyCurve((dir + "_AK8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_AK8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Fat jet IVFCSV (Explicit JTA) - CA"]                       = getEfficiencyCurve((dir + "_CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_CA8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - AK"] = getEfficiencyCurve((dir + "_AK8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_AK8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  graphsPt300To500["Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - CA"] = getEfficiencyCurve((dir + "_CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_CA8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  ...
  orderingPt300To500.push_back("Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - CA");
  //-------------------------------------------------
  graphsPt700ToInf["Fat jet IVFCSV (Explicit JTA) - AK"]                       = getEfficiencyCurve((dir + "_AK8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_AK8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       700,1100);
  graphsPt700ToInf["Fat jet IVFCSV (Explicit JTA) - CA"]                       = getEfficiencyCurve((dir + "_CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_CA8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       700,1100);
  graphsPt700ToInf["Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - AK"] = getEfficiencyCurve((dir + "_AK8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_AK8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 700,1100);
  graphsPt700ToInf["Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - CA"] = getEfficiencyCurve((dir + "_CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_CA8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 700,1100);
  ...
  orderingPt700ToInf.push_back("Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - CA");
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, "#splitline{R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}", "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic W)", "", ("btagperfcomp_Pt300to500_FatJets_Subjets_AK_vs_CA_Hadronic_W." + ext).c_str(), 0, 1, 1E-3, 1, 1);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, "#splitline{R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}",     "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic W)", "", ("btagperfcomp_Pt700toInf_FatJets_Subjets_AK_vs_CA_Hadronic_W." + ext).c_str(), 0, 1, 1E-3, 1, 1);
  ...
  //-------------------------------------------------
  // Fat jets and subjets, AK8 vs CA8 -- Boosted hadronic Z
  //-------------------------------------------------
  graphsPt300To500["Fat jet IVFCSV (Explicit JTA) - AK"]                       = getEfficiencyCurve((dir + "_AK8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_AK8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Fat jet IVFCSV (Explicit JTA) - CA"]                       = getEfficiencyCurve((dir + "_CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_CA8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - AK"] = getEfficiencyCurve((dir + "_AK8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_AK8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  graphsPt300To500["Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - CA"] = getEfficiencyCurve((dir + "_CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_CA8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  ...
  orderingPt300To500.push_back("Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - CA");
  //-------------------------------------------------
  graphsPt700ToInf["Fat jet IVFCSV (Explicit JTA) - AK"]                       = getEfficiencyCurve((dir + "_AK8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_AK8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       700,1100);
  graphsPt700ToInf["Fat jet IVFCSV (Explicit JTA) - CA"]                       = getEfficiencyCurve((dir + "_CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_CA8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       700,1100);
  graphsPt700ToInf["Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - AK"] = getEfficiencyCurve((dir + "_AK8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_AK8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 700,1100);
  graphsPt700ToInf["Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - CA"] = getEfficiencyCurve((dir + "_CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_CA8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 700,1100);
  ...
  orderingPt700ToInf.push_back("Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - CA");
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, "#splitline{R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}", "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic Z)", "", ("btagperfcomp_Pt300to500_FatJets_Subjets_AK_vs_CA_Hadronic_Z." + ext).c_str(), 0, 1, 1E-2, 1, 1);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, "#splitline{R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}",     "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic Z)", "", ("btagperfcomp_Pt700toInf_FatJets_Subjets_AK_vs_CA_Hadronic_Z." + ext).c_str(), 0, 1, 1E-2, 1, 1);
  ...
  //-------------------------------------------------
  // Fat jets and subjets, AK8 vs CA8 -- Boosted hadronic top
  //-------------------------------------------------
  graphsPt300To500["Fat jet IVFCSV (Explicit JTA) - AK"]                       = getEfficiencyCurve((dir + "_AK8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_AK8/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Fat jet IVFCSV (Explicit JTA) - CA"]                       = getEfficiencyCurve((dir + "_CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_CA8/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - AK"] = getEfficiencyCurve((dir + "_AK8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_AK8/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  graphsPt300To500["Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - CA"] = getEfficiencyCurve((dir + "_CA8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_CA8/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  ...
  orderingPt300To500.push_back("Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - CA");
  //-------------------------------------------------
  graphsPt700ToInf["Fat jet IVFCSV (Explicit JTA) - AK"]                       = getEfficiencyCurve((dir + "_AK8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_AK8/TprimeToTHinc_M-1700_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       700,1100);
  graphsPt700ToInf["Fat jet IVFCSV (Explicit JTA) - CA"]                       = getEfficiencyCurve((dir + "_CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_CA8/TprimeToTHinc_M-1700_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       700,1100);
  graphsPt700ToInf["Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - AK"] = getEfficiencyCurve((dir + "_AK8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_AK8/TprimeToTHinc_M-1700_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 700,1100);
  graphsPt700ToInf["Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - CA"] = getEfficiencyCurve((dir + "_CA8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_CA8/TprimeToTHinc_M-1700_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 700,1100);
  ...
  orderingPt700ToInf.push_back("Subjet IVFCSV (Pruned, Explicit JTA, SV Clustering) - CA");
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, "#splitline{R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}", "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic top)", "", ("btagperfcomp_Pt300to500_FatJets_Subjets_AK_vs_CA_Hadronic_top." + ext).c_str(), 0, 1, 1E-2, 1, 1);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, "#splitline{R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}",     "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic top)", "", ("btagperfcomp_Pt700toInf_FatJets_Subjets_AK_vs_CA_Hadronic_top." + ext).c_str(), 0, 1, 1E-2, 1, 1);
...
void makePlotsQCDStdJets(const string & dir = "ROOT_files", const string & algo = "AK", const double Ymin = 1e-3, const Int_t Logy = 1, const string & flavor = "", const string & ext = "eps")
{
  ...
  // Post-BTV-13-001 setup
  //==========================================
  // Fat jets, subjets and standard jets
  //-------------------------------------------------
  graphsPt300To500["Fat jet IVFCSV"]            = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       getHistName("Pruned","JetIVFCSV",flavor),       300,500);
  graphsPt300To500["Subjet IVFCSV"]             = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), getHistName("Pruned","SubJetMinIVFCSV",flavor), 300,500);
  graphsPt300To500["Matched AK4 IVFCSV (#times1)"]  = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetIVFCSV"),    getHistName("Pruned","StdJetIVFCSV",flavor),    300,500);
  graphsPt300To500["Matched AK4 IVFCSV (#times2)"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetMinIVFCSV"), getHistName("Pruned","StdJetMinIVFCSV",flavor), 300,500);

  orderingPt300To500.push_back("Fat jet IVFCSV");
  orderingPt300To500.push_back("Subjet IVFCSV");
  orderingPt300To500.push_back("Matched AK4 IVFCSV (#times1)");
  orderingPt300To500.push_back("Matched AK4 IVFCSV (#times2)");
  //-------------------------------------------------
  graphsPt700ToInf["Fat jet IVFCSV"]            = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       getHistName("Pruned","JetIVFCSV",flavor),       700,1100);
  graphsPt700ToInf["Subjet IVFCSV"]             = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), getHistName("Pruned","SubJetMinIVFCSV",flavor), 700,1100);
  graphsPt700ToInf["Matched AK4 IVFCSV (#times1)"]  = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetIVFCSV"),    getHistName("Pruned","StdJetIVFCSV",flavor),    700,1000);
  graphsPt700ToInf["Matched AK4 IVFCSV (#times2)"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetMinIVFCSV"), getHistName("Pruned","StdJetMinIVFCSV",flavor), 700,1000);

  orderingPt700ToInf.push_back("Fat jet IVFCSV");
  orderingPt700ToInf.push_back("Subjet IVFCSV");
  orderingPt700ToInf.push_back("Matched AK4 IVFCSV (#times1)");
  orderingPt700ToInf.push_back("Matched AK4 IVFCSV (#times2)");
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "#DeltaR(AK4 jets,fat jet)<0.5", ("btagperfcomp_Pt300to500_FatJets_Subjets_StdJets_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", ("Misid. probability (" + flv  + ")").c_str(), "#DeltaR(AK4 jets,fat jet)<0.5", ("btagperfcomp_Pt700toInf_FatJets_Subjets_StdJets_" + algo + (flavor != "" ? "_" + flavor : "") + "." + ext).c_str(), 0, 1, Ymin, 1, Logy);
...
void makePlotsOtherStdJets(const string & dir = "ROOT_files", const string & algo = "AK", const string & ext = "eps")
{
  // for multiple plots on the same canvas
  ...
  // Post-BTV-13-001 setup
  //==========================================
  // Fat jets, subjets and standard jets -- Boosted hadronic W
  //-------------------------------------------------
  graphsPt300To500["Fat jet IVFCSV"]            = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Subjet IVFCSV"]             = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  graphsPt300To500["Matched AK4 IVFCSV (#times1)"]  = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetIVFCSV"),    300,500);
  graphsPt300To500["Matched AK4 IVFCSV (#times2)"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetMinIVFCSV"), 300,500);
  ...
  graphsPt700ToInf["Fat jet IVFCSV"]            = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       700,1100);
  graphsPt700ToInf["Subjet IVFCSV"]             = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 700,1100);
  graphsPt700ToInf["Matched AK4 IVFCSV (#times1)"]  = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetIVFCSV"),    700,1000);
  graphsPt700ToInf["Matched AK4 IVFCSV (#times2)"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeTprimeToBWBWinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetMinIVFCSV"), 700,1000);
  ...
  orderingPt700ToInf.push_back("Matched AK4 IVFCSV (#times2)");
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic W)", "#DeltaR(AK4 jets,fat jet)<0.5", ("btagperfcomp_Pt300to500_FatJets_Subjets_StdJets_" + algo + "_Hadronic_W." + ext).c_str(), 0, 1, 1E-3, 1, 1);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic W)", "#DeltaR(AK4 jets,fat jet)<0.5", ("btagperfcomp_Pt700toInf_FatJets_Subjets_StdJets_" + algo + "_Hadronic_W." + ext).c_str(), 0, 1, 1E-3, 1, 1);
  ...
  //-------------------------------------------------
  // Fat jets, subjets and standard jets -- Boosted hadronic Z
  //-------------------------------------------------
  graphsPt300To500["Fat jet IVFCSV"]            = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Subjet IVFCSV"]             = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  graphsPt300To500["Matched AK4 IVFCSV (#times1)"]  = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetIVFCSV"),    300,500);
  graphsPt300To500["Matched AK4 IVFCSV (#times2)"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetMinIVFCSV"), 300,500);
  ...
  graphsPt700ToInf["Fat jet IVFCSV"]            = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       700,1100);
  graphsPt700ToInf["Subjet IVFCSV"]             = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 700,1100);
  graphsPt700ToInf["Matched AK4 IVFCSV (#times1)"]  = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetIVFCSV"),    700,1000);
  graphsPt700ToInf["Matched AK4 IVFCSV (#times2)"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/BprimeBprimeToBZBZinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetMinIVFCSV"), 700,1000);
  ...
  orderingPt700ToInf.push_back("Matched AK4 IVFCSV (#times2)");
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic Z)", "#DeltaR(AK4 jets,fat jet)<0.5", ("btagperfcomp_Pt300to500_FatJets_Subjets_StdJets_" + algo + "_Hadronic_Z." + ext).c_str(), 0, 1, 1E-2, 1, 1);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic Z)", "#DeltaR(AK4 jets,fat jet)<0.5", ("btagperfcomp_Pt700toInf_FatJets_Subjets_StdJets_" + algo + "_Hadronic_Z." + ext).c_str(), 0, 1, 1E-2, 1, 1);
  ...
  //-------------------------------------------------
  // Fat jets, subjets and standard jets -- Boosted hadronic top
  //-------------------------------------------------
  graphsPt300To500["Fat jet IVFCSV"]            = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Subjet IVFCSV"]             = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  graphsPt300To500["Matched AK4 IVFCSV (#times1)"]  = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetIVFCSV"),    300,500);
  graphsPt300To500["Matched AK4 IVFCSV (#times2)"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetMinIVFCSV"), 300,500);
  ...
  graphsPt700ToInf["Fat jet IVFCSV"]            = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1700_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","JetIVFCSV"),       700,1100);
  graphsPt700ToInf["Subjet IVFCSV"]             = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1500_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1700_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","SubJetMinIVFCSV"), 700,1100);
  graphsPt700ToInf["Matched AK4 IVFCSV (#times1)"]  = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1700_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetIVFCSV"),    700,1000);
  graphsPt700ToInf["Matched AK4 IVFCSV (#times2)"] = getEfficiencyCurve((dir + "_" + algo + "8/BprimeBprimeToBHBHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), (dir + "_" + algo + "8/TprimeToTHinc_M-1700_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3.root").c_str(), getHistName("Pruned","StdJetMinIVFCSV"), 700,1000);
  ...
  orderingPt700ToInf.push_back("Matched AK4 IVFCSV (#times2)");
  //-------------------------------------------------
  plotEfficiencyCurves(graphsPt300To500,orderingPt300To500, ("#splitline{" + algo + " R=0.8, 300<p_{T}<500 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(), "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic top)", "#DeltaR(AK4 jets,fat jet)<0.5", ("btagperfcomp_Pt300to500_FatJets_Subjets_StdJets_" + algo + "_Hadronic_top." + ext).c_str(), 0, 1, 1E-2, 1, 1);
  plotEfficiencyCurves(graphsPt700ToInf,orderingPt700ToInf, ("#splitline{" + algo + " R=0.8, p_{T}>700 GeV/c}{75<m_{pruned}<135 GeV/c^{2}}").c_str(),     "Tagging efficiency (H#rightarrowb#bar{b})", "Misid. probability (Hadronic top)", "#DeltaR(AK4 jets,fat jet)<0.5", ("btagperfcomp_Pt700toInf_FatJets_Subjets_StdJets_" + algo + "_Hadronic_top." + ext).c_str(), 0, 1, 1E-2, 1, 1);
...
//   makePlotsOtherStdJets("ROOT_files", "AK");   // AK8
  ...
  graphsPt300To500["Fat jet IVFCSV (CSA14 V6)"] = getEfficiencyCurve("ROOT_files_AK8_CSA14/BprimeBprime_M-1000_HiggsTagging_ExplicitJTA_SVClustering_CSA14_V6.root",       "ROOT_files_AK8_CSA14/QCDPythia8_HiggsTagging_ExplicitJTA_SVClustering_CSA14_V6.root", getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Subjet IVFCSV (CSA14 V6)"]  = getEfficiencyCurve("ROOT_files_AK8_CSA14/BprimeBprime_M-1000_HiggsTagging_ExplicitJTA_SVClustering_CSA14_V6.root",       "ROOT_files_AK8_CSA14/QCDPythia8_HiggsTagging_ExplicitJTA_SVClustering_CSA14_V6.root", getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  graphsPt300To500["Fat jet IVFCSV (CSA14 V5)"] = getEfficiencyCurve("ROOT_files_AK8_CSA14/BprimeBprime_M-1000_HiggsTagging_ExplicitJTA_SVClustering_CSA14_V5.root",       "ROOT_files_AK8_CSA14/QCDPythia8_HiggsTagging_ExplicitJTA_SVClustering_CSA14_V5.root", getHistName("Pruned","JetIVFCSV"),       300,500);
  graphsPt300To500["Subjet IVFCSV (CSA14 V5)"]  = getEfficiencyCurve("ROOT_files_AK8_CSA14/BprimeBprime_M-1000_HiggsTagging_ExplicitJTA_SVClustering_CSA14_V5.root",       "ROOT_files_AK8_CSA14/QCDPythia8_HiggsTagging_ExplicitJTA_SVClustering_CSA14_V5.root", getHistName("Pruned","SubJetMinIVFCSV"), 300,500);
  ...
  orderingPt300To500.push_back("Fat jet IVFCSV (CSA14 V6)");
  orderingPt300To500.push_back("Subjet IVFCSV (CSA14 V6)");
  orderingPt300To500.push_back("Fat jet IVFCSV (CSA14 V5)");
  orderingPt300To500.push_back("Subjet IVFCSV (CSA14 V5)");
