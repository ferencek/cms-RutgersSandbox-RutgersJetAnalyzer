...
process.jetAnalyzerCAFatJets_FilteredSubjets = process.jetAnalyzerCAFatJets_PrunedSubjets.clone(
    GroomedBasicJetsTag       = cms.InputTag('selectedPatJetsCAFilteredPFCHSPacked'),
    SubJetMode                = cms.string('Filtered')
)
process.jetAnalyzerCAFatJets_MDBDRSFilteredSubjets = process.jetAnalyzerCAFatJets_PrunedSubjets.clone(
    GroomedBasicJetsTag       = cms.InputTag('selectedPatJetsCAMDBDRSFilteredPFCHSPacked'),
    SubJetMode                = cms.string('Filtered')
)
process.jetAnalyzerCAFatJets_KtBDRSFilteredSubjets = process.jetAnalyzerCAFatJets_PrunedSubjets.clone(
    GroomedBasicJetsTag       = cms.InputTag('selectedPatJetsCAKtBDRSFilteredPFCHSPacked'),
    SubJetMode                = cms.string('Filtered')
)
process.jetAnalyzerCAFatJets_KtSubjets = process.jetAnalyzerCAFatJets_PrunedSubjets.clone(
