				 ...
				 const Double_t fTitleOffsetX=1.0, const Double_t fTitleOffsetY=1.0, const Double_t fLeftMargin=0.12, const Double_t fTopMargin=0.07, const Double_t fPlotWidth=0.8)
{
  ...
  legend->SetTextFont(42);
  legend->SetTextSize(0.04);
  legend->AddEntry(g_efficiency1, "H(125)#rightarrowb#bar{b}","lp");
...
void makePlots()
{
  ...
  efficiency1D_overlayMulti_6("ROOT_files/jobs_6_forApproval/RadionToHH_4b_M-600_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3_R1p2.root",
                              "ROOT_files/jobs_6_forApproval/TprimeTprimeToBWBWinc_M-800_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3_R1p2.root",
                              "ROOT_files/jobs_6_forApproval/BprimeBprimeToBZBZinc_M-1200_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3_R1p2.root",
                              "ROOT_files/jobs_6_forApproval/TprimeToTHinc_M-1000_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3_R1p2.root",
                              "ROOT_files/jobs_6_forApproval/QCDPythia6_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3_R1p2.root",
                              "jetAnalyzerFatJets_PrunedSubjets", "h1_JetPt_BosonMatched_JetMass_SubJetMinIVFCSVL", "h1_JetPt_BosonMatched_JetMass",
                              "#splitline{AK R=1.2}{90<m_{pruned}<150 GeV/c^{2}, Subjet IVFCSVL}",
                              "Fat jet p_{T} [GeV/c]", "Tagging efficiency", 25, 0, 1000, 3E-3, 1,
                              "b-tag_eff_vs_FatJetPt_SubjetIVFCSVL_PrunedJetMass.eps", 1, 1);
  ...
  efficiency1D_overlayMulti_6("ROOT_files/jobs_6_forApproval/RadionToHH_4b_M-600_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3_R1p2.root",
                              ...
                              "#splitline{AK R=1.2}{90<m_{pruned}<150 GeV/c^{2}, Subjet IVFCSVM}",
  ...
  efficiency1D_overlayMulti_6("ROOT_files/jobs_6_forApproval/RadionToHH_4b_M-600_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3_R1p2.root",
                              ...
                              "#splitline{AK R=1.2}{90<m_{pruned}<150 GeV/c^{2}, Fat jet IVFCSVL}",
  ...
  efficiency1D_overlayMulti_6("ROOT_files/jobs_6_forApproval/RadionToHH_4b_M-600_HiggsTagging_ExplicitJTA_SVClustering_PATTuple_v3_R1p2.root",
                              ...
                              "#splitline{AK R=1.2}{90<m_{pruned}<150 GeV/c^{2}, Fat jet IVFCSVM}",
                              "Fat jet p_{T} [GeV/c]", "Tagging efficiency", 25, 0, 1000, 3E-3, 1,
                              "b-tag_eff_vs_FatJetPt_FatJetIVFCSVM_PrunedJetMass.eps", 1, 1);
